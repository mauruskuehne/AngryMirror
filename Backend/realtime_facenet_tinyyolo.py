...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        modeldir = '/Users/samuelochsner/facerecognition/faceRecognition-yolo-facenet/models/facenet/20191103-184032'
        ...
        while True:
            ...
            if (c % timeF == 0):
                ...
                interpreter = tf.lite.Interpreter(model_path="/Users/samuelochsner/facerecognition/faceRecognition-yolo-facenet/model-weights/yolov3-tiny.tflite")
                ...
                input_data = y = np.transpose(blob, (0, 2, 3, 1))
                print(input_data.shape)
                shape = input_details[0]['index']
                ...
                bounding_boxes = handle_predictions(predictions)
